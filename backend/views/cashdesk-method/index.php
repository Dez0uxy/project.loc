...
/* @var $searchModel backend\models\CashdeskMethodSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title                   = Yii::t('app', 'Методи оплати');
    ...
    <div class="container">
        ...
        <div class="card card-lg">
            <div class="card-body">
                ...
                <div class="cashdesk-method-index">
                    ...
                    <?= GridView::widget([
                        ...
                        'columns'      => [
                            ...
                            [
                                ...
                                'urlCreator'    => function ($action, \common\models\CashdeskMethod $model, $key, $index, $column) {
