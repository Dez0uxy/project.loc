...
use backend\models\WarehousemanForm;
use common\models\Customer;
use common\models\User;
use backend\models\WarehousemanSearch;
...
class WarehousemanController extends Controller
{
    ...
    {
        $searchModel = new WarehousemanSearch();
    ...
    {
        $model = new WarehousemanForm(['scenario' => WarehousemanForm::SCENARIO_UPDATE]);

        if ($model->load(Yii::$app->request->post(), 'WarehousemanForm') && $new = $model->upd($id)) {
